    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.containerCard}>
                <Image className={styles.containerImg} src={"/img/centralizedicon.png"} width={100} height={100} alt='icon centralized supplier'></Image>
            ...
            <div className={styles.containerCard}>
                <Image src={"/img/demandicon2.png"} width={80} height={80} alt='icon demand forecasting'></Image>
            ...
            <div className={styles.containerCard}>
                <Image src={"/img/wasteicon.png"} width={100} height={100} alt='icon waste reduction'></Image>
            ...
            <div className={styles.containerCard}>
                <Image src={"/img/boostingicon.png"} width={100} height={100} alt='icon boosting competitiveness'></Image>
